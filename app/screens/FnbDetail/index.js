...
export default function FnbDetail({navigation}) {
  ...
  // useEffect(() => {
  //   console.log('Selected Public Services:', JSON.stringify(item.lat));
  // }, []);
  ...
  return (
    <View style={{flex: 1}}>
      <Animated.View
        ...
        <Image source={{uri: item.imageSrc[0].url}} style={{flex: 1}} />
        <Animated.View
          style={{
            position: 'absolute',
            flexDirection: 'row',
        ...
        >
          ...
          <View
            ...
            <Text body2 grayColor style={{marginTop: 10, marginBottom: 20}}>
                Open Hour: {`${item.open_hour} AM - ${item.close_hour} PM`}
            </Text>
            <Text body2 semibold>
              {t('address')}
            </Text>
            ...
            {item.menu.length > 0 ? (
                ...
                <React.Fragment key={index}>
                    ...
                    {menu.name} {/* Assuming each menu has a name */}
                    </Text>
                    <Text body2 grayColor style={{ marginVertical: 5 }}>
                    {menu.description} {/* Assuming each menu has a description */}
                    </Text>
                ...
                Sorry, this tenant does not have a menu yet.
                </Text>
            )}
            </View>
