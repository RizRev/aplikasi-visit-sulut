...
import {FlatList, RefreshControl, View, Animated, Image} from 'react-native';
...
import { getHotels } from '../../data/hotel';// adjust the path according to your project structure
            ...
            <Animated.FlatList
              ...
              renderItem={({item, index}) => (
                <HotelItem
                  ...
                  price={item.price}
                  available={`Available Room: ${item.roomType[0].available}`}
                  rate={item.rateCount}
